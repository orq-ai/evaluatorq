...
from evaluatorq.common.reports import CACHED_TOKENS_LABEL, cost_coverage, fmt_cached_tokens, fmt_cost
...
def build_token_usage_rows(data: Mapping[str, Any]) -> list[list[str]]:
    ...
    if cached:
        ...
        rows.append([CACHED_TOKENS_LABEL, fmt_cached_tokens(cached, input_tokens)])
