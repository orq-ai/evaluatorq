...
def runs(
    ...
    try:
        ...
        # File is the unique identifier you copy into `eq dashboard`, so it must
        # never be ellipsised away on a narrow terminal — fold it onto extra
        # lines instead of dropping characters.
