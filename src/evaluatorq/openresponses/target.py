    ...
    async def _do_call(
        ...
        *,
        ...
        async with with_llm_span(
            ...
            try:
                response, response_headers = await self._create(
        ...
        return self._normalise_response(response, trace_id=trace_id, span_id=span_id)
        ...
        *,
        ...
        try:
            ...
            return await with_retry(
                lambda: self._do_call(responses_input=responses_input, timeout_s=timeout_s),
