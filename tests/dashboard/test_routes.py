...
class TestReportRoute:
    ...
    def test_malformed_redteam_report_returns_error_page_not_500(self, tmp_path: Path) -> None:
        ...
        (rt / 'broken_20260101_000000.json').write_text(json.dumps({'pipeline': 'static', 'results': []}))
