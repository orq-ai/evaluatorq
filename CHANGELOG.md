...
- `RedTeamReport.token_usage_summary` removed. The attribute was public and always `None` — nothing ever populated it. Read `RedTeamReport.summary.token_usage_total` for the run's usage instead.
